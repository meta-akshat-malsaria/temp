...
*/
insert into user(name,contactNo,email,DOB,admin) values("akshat malsaria",7427048409,"aks@gmail.com","1998-09-21",false);
insert into user(name,contactNo,email,DOB,admin) values("yatin anand",7456345757,"yat@gmail.com","1999-01-15",false);
insert into user(name,contactNo,email,DOB,admin) values("aditya maheshwari",6783497465,"addi@gmail.com","1998-08-20",false);
insert into user(name,contactNo,email,DOB,admin) values("kushagra goel",7878776665,"kus@gmail.com","1998-03-04",false);
insert into user(name,contactNo,email,DOB,admin) values("abhijeet sharma",9356767456,"abh@gmail.com","1979-02-07",false);
insert into user(name,contactNo,email,DOB,admin) values("rashmi jain",4596996390,"ras@gmail.com","1998-10-07",false);
insert into user(name,contactNo,email,DOB,admin) values("saloni sharma",9789654678,"sal@gmail.com","1999-07-30",false);
insert into user(name,contactNo,email,DOB,admin) values("mansi joshi",9896654542,"man@gmail.com","1999-12-11",false);
